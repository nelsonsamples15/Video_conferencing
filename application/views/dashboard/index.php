    ...
    <!-- Old socket.io -->
     <!-- <script type="text/javascript" src="<?php echo base_url(); ?>assets/nodejs/node_modules/socket.io/node_modules/socket.io-client/socket.io.js"></script> -->
    <!-- New socket.io -->
   <script type="text/javascript" src="<?php echo base_url(); ?>assets/nodejs/node_modules/socket.io-client/dist/socket.io.js"></script> 
		...
		<div class="col-sm-12">
			<div class="row videos">
	            <div id="remote-videos">
	            	<!-- <video id="video1" width="100%" height="200" autoplay muted></video>
				    <video id="video2" width="100%" height="200" autoplay muted></video>
				    <video id="video3" width="100%" height="200" autoplay muted></video> -->
	            ...
	            <div id="local-videos">
	              ...
	              <!-- <video width="100%" height="200" autoplay="true" id="localVideo" style="border-radius: 20px" muted></video> -->
            	</div>
            	<div class="clearfix"></div>
		...
		<div id="videos">
                <div id="videosWrapper">
				    <div id="localVideoWrap" class='videoWrap'>
					    <video class="videoBox" width="100%" height="200" id="localVideo" autoplay></video>
					</div>
                </div>
			</div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/original/js/common.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/original/js/my_own.js"></script>
