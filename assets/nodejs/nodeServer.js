	...
	io.sockets.on('connection', function(client) {
	    ...
	    // convenience function to log server messages on the client
		 ...
		 //    // for a real app, would be room only (not broadcast)
			...
			// My own video conference
			
			// client.on('transfer_event', function (oData) {
		 //    	// for a real app, would be room only (not broadcast)
			// 	client.broadcast.emit('transfer_event', oData);
			// });

			// client.on('transfer_desc_local', function (oData) {
		 //    	// for a real app, would be room only (not broadcast)
			// 	client.broadcast.emit('transfer_desc_local', oData);
			// });

			// client.on('transfer_desc_remote', function (oData) {
		 //    	// for a real app, would be room only (not broadcast)
			// 	client.broadcast.emit('transfer_desc_remote', oData);
			// });
